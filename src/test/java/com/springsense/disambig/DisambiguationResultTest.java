...
public class DisambiguationResultTest {
    ...
    @Test
    public void testVariantsForOneMeaningSentence() {
        final List<VariantSentence> singleMeaningVariants = singleMeaningsSentence.getVariants();
        final VariantSentence variant = singleMeaningVariants.get(0);
        final ResolvedTerm flour_n_01 = variant.getTerms().get(variant.getTerms().size() - 2);
        ...
        assertEquals("Send them into another one can make little feculina flour_n_01 .", variant.toString());
