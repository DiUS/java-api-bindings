...
public class MeaningRecognitionAPICacheTest {
	...
	private Map<String, String> expectedAuthParameters;
	...
	public void setUp() {
		...
		expectedAuthParameters = api.getAuthorizationParameters();
	}
	...
	public void cacheShouldReduceTheNumberOfActualCallsToServerMassively()
		...
		int expectedNumberOfCalls = 8; // Must be ~80% or less of cache size to avoid evictions
